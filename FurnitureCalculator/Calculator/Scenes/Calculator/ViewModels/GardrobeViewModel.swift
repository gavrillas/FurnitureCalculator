...
struct GardrobeViewModel: CalculatorViewModel {
    ...
    let componentType: Component.ComponentType = .Gardrobe
    ...
    init(furniture: Furniture, component: Component?, useCase: ComponentUseCase) {
        ...
        resultViewModels = [EntireTopBottomViewModel(input: input, boardName: "Tető", savedBoards: savedBoards),
                            EntireTopBottomViewModel(input: input, boardName: "Fenék", savedBoards: savedBoards),
                             ...
                             GardrobeDoorViewModel(input: input, boardName: "Tolóajtók", savedBoards: savedBoards),
                             GardrobeDrawerFrontBackViewModel(input: input, boardName: "Fiók eleje - hátulja", savedBoards: savedBoards),
                             GardrobeDrawerSideViewModel(input: input, boardName: "Fiók oldal", savedBoards: savedBoards),]
    }
}
